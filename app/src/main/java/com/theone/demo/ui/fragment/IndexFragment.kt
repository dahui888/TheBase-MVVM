...
class IndexFragment : BaseIndexTabFragment<BaseViewModel>() {
    ...
    override fun createTabBuilder(): QMUITabBuilder? {
        return super.createTabBuilder()?.apply {
            // 选中图标的颜色可以在这里设置
    ...
    override fun initTabAndFragments(
        ...
        with(tabs){
            ...
            add(QMUITabBean("首页", R.drawable.svg_home, R.drawable.svg_home_select))
            // skinChangeWithTintColor = false 时   颜色直接使用的是选中图标本身的颜色 使用 ?attr/app_skin_primary_color 填充
            add(QMUITabBean("项目", R.drawable.svg_project, R.drawable.svg_project_selected))
            add(QMUITabBean("分类", R.drawable.svg_classfication, R.drawable.svg_classification_selected))
            add(QMUITabBean("公众号", R.drawable.svg_wx_gzh, R.drawable.svg_wx_gzh_selected))
            add(QMUITabBean("我的", R.drawable.svg_mine, R.drawable.svg_mine_selected))
        }
