package com.theone.mvvm.core.widge.pullrefresh;
...
public class WWLoadingView extends View implements QMUIPullRefreshLayout.IRefreshView  {
    ...
    private int mSize = getResources().getDimensionPixelSize(R.dimen.pull_fresh_ww_size);
    private ValueAnimator mAnimator;
    private float mOriginInset;
    private float mCurrentPercent = 0;

    public WWLoadingView(Context context) {
        super(context);
        init(context);
    }
