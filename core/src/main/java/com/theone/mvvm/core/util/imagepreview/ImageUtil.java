package com.theone.mvvm.core.util.imagepreview;
...
public class ImageUtil {
    ...
    public static boolean isLongImage(Context context, String imagePath) {
        ...
        float ratio = ((float) QMUIDisplayHelper.getScreenHeight(context))/ ((float) QMUIDisplayHelper.getScreenWidth(context));
        float phoneRatio = ratio + 0.1F;
    ...
    public static boolean isSmallImage(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        boolean isSmallImage = wh[0] < QMUIDisplayHelper.getScreenWidth(context);
        return isSmallImage;
    }
    ...
    public static float getLongImageMinScale(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        float imageWid = wh[0];
        float phoneWid = QMUIDisplayHelper.getScreenWidth(context);
    ...
    public static float getWideImageDoubleScale(Context context, String imagePath) {
        int[] wh = getWidthHeight(imagePath);
        float imageHei = wh[1];
        float phoneHei = QMUIDisplayHelper.getScreenHeight(context);
