...
class DownloadService : Service() {
    ...
    private fun initNotification() {
        mNotificationBuilder = NotificationManager.INSTANCE.createNotification(
            NOTIFICATION_ID,
            "开始下载",
            "开始下载",
            mDownload?.url
    ...
    private fun updateNotification(title: String, isFinish: Boolean) {
        stopForeground(true)
        val builder = NotificationManager.INSTANCE.createNotification(
        ...
        NotificationManager.INSTANCE.notify(NOTIFICATION_ID, builder)
        stopSelf()
    }
    ...
    private fun updateProgress(percent: Int) {
        ...
        NotificationManager.INSTANCE.notify(NOTIFICATION_ID, mNotificationBuilder)
    }
