...
import com.theone.mvvm.core.util.glide.GlideProgressInterceptor
import com.theone.mvvm.core.util.imagepreview.FileTarget
import com.theone.mvvm.core.util.imagepreview.ImageLoader
import com.theone.mvvm.core.util.imagepreview.ImageUtil
import java.io.File
...
class ImageSnapAdapter<T : IImageUrl>(private val onImageSnapClickListener: OnImageSnapClickListener<T>? = null) :
    ...
    override fun convert(holder: BaseDataBindingHolder<ItemImageSnapBinding>, item: T) {
        ...
        holder.dataBinding?.run {
            ...
            } else loadImage(url, photoView, longImg, progressbar, 1, ivPlay, item.isVideo())
    ...
    @SuppressLint("CheckResult")
    private fun loadGifImageSpec(imagePath: String, imageGif: ImageView, imageView: SubsamplingScaleImageView, progressBar: QMUIProgressBar){
