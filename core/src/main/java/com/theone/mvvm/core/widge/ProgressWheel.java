package com.theone.mvvm.core.widge;
...
public class ProgressWheel extends View implements IQMUISkinHandlerView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (isSpinning) {
			...
			if (mProgress > 360) {
				...
				// do something, like changing the type_color_selector
				runCallback(-1.0f);
			}
	...
	/**
	 * @return the type_color_selector of the spinning bar
	 */
	...
	/**
	 * Sets the type_color_selector of the spinning bar
	 *
	 * @param barColor
	 *            The spinning bar type_color_selector
	 */
	...
	/**
	 * @return the type_color_selector of the wheel's contour
	 */
	...
	/**
	 * Sets the type_color_selector of the wheel's contour
	 *
	 * @param rimColor
	 *            the type_color_selector for the wheel
	 */
